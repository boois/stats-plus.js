(function(h,g){"object"===typeof exports&&"undefined"!==typeof module?module.exports=g():"function"===typeof define&&define.amd?define(g):(h=h||self,h.Stats=g())})(this,function(){var h=function(g,n){function l(a){c.appendChild(a.dom);return a}function p(a){for(var d=0;d<c.children.length;d++)c.children[d].style.display=d===a?"block":"none";t=a}this.scene=g;this.renderer=n;var t=0,c=document.createElement("div");c.style.cssText="position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000;use-select:none;";
